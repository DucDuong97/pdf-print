...
public class PdfTime extends PdfQuestion<Object> {
    public PdfTime(String name, Object obj, String defaultValue, boolean readOnly, String note, int level) {
    ...
    public void print(float x, float y, FieldPrinter fieldPrinter) {
        ...
        fieldPrinter.addTimeDropDown(name, defaultValue, x, y);
    }
}
